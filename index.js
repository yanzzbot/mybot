...
*/
const XPTN = 🐼'YanzzBotQu🐼'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/_zxuan54'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://Wa.me/+6281803522862'; // JANGAN DI UBAH NANTI EROR
const aktif = 'Sesuai Selera'; // DI GANTI AUTO EROR
const groupwa = '-'; // DI GANTI AUTO EROR
const youtube = 'https://www.youtube.com/channel/YanzzOfficial'; // DI GANTI AUTO EROR
//
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾YanzzBotQu👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@_zxuan54' ,MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾YanzzBotQu👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@_zxuan54' ,MessageType.text);
}
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾YanzzBOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@_zxuan54' ,MessageType.text);
}
else if (text == '.tools5'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾YanzzBotQu👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@_zxuan54' ,MessageType.text);
}
